...
{
    public class PutHospitalExit
    {
        public PutHospitalExit()
        {
            OfficerToTakeAction = new List<PutHospitalExitOfficerToTakeAction>();
        }
        ...
        public List<PutHospitalExitOfficerToTakeAction> OfficerToTakeAction { get; set; }
    }
}
