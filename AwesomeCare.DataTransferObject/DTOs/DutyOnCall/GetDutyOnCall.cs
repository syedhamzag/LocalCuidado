...
{
    public class GetDutyOnCall
    {
        public GetDutyOnCall()
        {
            PersonResponsible = new List<GetDutyOnCallPersonResponsible>();
            PersonToAct = new List<GetDutyOnCallPersonToAct>();
        }
        ...
        public List<GetDutyOnCallPersonResponsible> PersonResponsible { get; set; }
        public List<GetDutyOnCallPersonToAct> PersonToAct { get; set; }
    }
}
