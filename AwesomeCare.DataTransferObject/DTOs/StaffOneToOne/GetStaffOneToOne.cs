...
{
    public class GetStaffOneToOne
    {
        public GetStaffOneToOne()
        {
            OfficerToAct = new List<GetOneToOneOfficerToAct>();
        }
        ...
        public List<GetOneToOneOfficerToAct> OfficerToAct { get; set; }
    }
}
