...
{
     public class PostHospitalEntry
    {
        public PostHospitalEntry()
        {
            StaffInvolved = new List<PostHospitalEntryStaffInvolved>();
            PersonToTakeAction = new List<PostHospitalEntryPersonToTakeAction>();
        }
        ...
        public List<PostHospitalEntryStaffInvolved> StaffInvolved { get; set; }
        public List<PostHospitalEntryPersonToTakeAction> PersonToTakeAction { get; set; }
    }
}
