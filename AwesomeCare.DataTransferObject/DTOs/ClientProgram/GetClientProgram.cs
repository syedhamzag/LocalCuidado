...
{
    public class GetClientProgram
    {
        public GetClientProgram()
        {
            OfficerToAct = new List<GetProgramOfficerToAct>();
        }
        ...
        public List<GetProgramOfficerToAct> OfficerToAct { get; set; }
    }
}
