...
{
    public class GetClientMgtVisit
    {
        public GetClientMgtVisit()
        {
            OfficerToAct = new List<GetVisitOfficerToAct>();
            StaffName = new List<GetVisitStaffName>();
        }
        ...
        public List<GetVisitOfficerToAct> OfficerToAct { get; set; }
        public List<GetVisitStaffName> StaffName { get; set; }
    }
}
