...
{
    public class PutComplainRegister
    {
        public PutComplainRegister()
        {
            OfficerToAct = new List<PutComplainOfficerToAct>();
            StaffName = new List<PutComplainStaffName>();
        }
        ...
        public List<PutComplainOfficerToAct> OfficerToAct { get; set; }
        public List<PutComplainStaffName> StaffName { get; set; }
    }
