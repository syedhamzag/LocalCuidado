...
{
    public class PostClientLogAudit
    {
        public PostClientLogAudit()
        {
            OfficerToAct = new List<PostLogAuditOfficerToAct>();
        }
        ...
        public List<PostLogAuditOfficerToAct> OfficerToAct { get; set; }
    }
}
