...
{
    public class GetClientBloodCoagulationRecord
    {
        public GetClientBloodCoagulationRecord()
        {
            OfficerToAct = new List<GetBloodCoagOfficerToAct>();
            Physician = new List<GetBloodCoagPhysician>();
            StaffName = new List<GetBloodCoagStaffName>();
        }
        ...
        public List<GetBloodCoagOfficerToAct> OfficerToAct { get; set; }
        public List<GetBloodCoagPhysician> Physician { get; set; }
        public List<GetBloodCoagStaffName> StaffName { get; set; }
    }
}
