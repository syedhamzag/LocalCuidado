...
{
    public partial class tbl_Client_Voice : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OfficeStaffSupport = table.Column<int>(nullable: false), // Mistake in View [Change D.Base To Dynamic]
                ...
                migrationBuilder.CreateIndex(
                    name: "IX_tbl_Client_Voice_VoiceId",
