...
{
    public partial class tbl_ClientPainChart : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "tbl_ClientPainChart",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_ClientPainChart", x => x.PainChartId);
                    table.ForeignKey(
                        name: "FK_tbl_ClientPainChart_tbl_Client_ClientId",
                        column: x => x.ClientId,
                ...
                migrationBuilder.CreateIndex(
                    name: "IX_tbl_ClientPainChart_PainChartId",
                    table: "tbl_ClientPainChart",
                    column: "PainChartId");
                }
