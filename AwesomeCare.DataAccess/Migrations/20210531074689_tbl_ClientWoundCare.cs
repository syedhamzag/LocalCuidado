...
{
    public partial class tbl_ClientWoundCare : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "tbl_ClientWoundCare",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_ClientWoundCare", x => x.WoundCareId);
                    table.ForeignKey(
                        name: "FK_tbl_ClientWoundCare_tbl_Client_ClientId",
                        column: x => x.ClientId,
                ...
                migrationBuilder.CreateIndex(
                    name: "IX_tbl_ClientWoundCare_WoundCareId",
                    table: "tbl_ClientWoundCare",
                    column: "WoundCareId");
                }
