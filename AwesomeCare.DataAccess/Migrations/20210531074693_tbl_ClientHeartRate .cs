...
{
    public partial class tbl_ClientHeartRate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "tbl_ClientHeartRate",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_ClientHeartRate", x => x.HeartRateId);
                    table.ForeignKey(
                        name: "FK_tbl_ClientHeartRate_tbl_Client_ClientId",
                        column: x => x.ClientId,
                ...
                migrationBuilder.CreateIndex(
                    name: "IX_tbl_ClientHeartRate_HeartRateId",
                    table: "tbl_ClientHeartRate",
                    column: "HeartRateId");
                }
