...
namespace AwesomeCare.API.Controllers
{
    ...
    public class ClientCareDetailsHeadingController : ControllerBase
    {
        ...
        public ClientCareDetailsHeadingController(IGenericRepository<ClientCareDetailsHeading> clientCareDetailsHeadingRepository, ILogger<ClientCareDetailsHeadingController> logger)
        {
