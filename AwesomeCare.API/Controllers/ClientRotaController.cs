...
namespace AwesomeCare.API.Controllers
{
    ...
    public class ClientRotaController : ControllerBase
    {
        ...
        public ClientRotaController(IGenericRepository<Rota> rotaRepository)
        {
        ...
        public IActionResult Get(int? id)
        {
            ...
            var getEntity = _rotaRepository.Table.ProjectTo<GetClientRota>().FirstOrDefault(d => d.RotaId == id && !d.Deleted);
        ...
        public async Task<IActionResult> Post([FromBody]PostClientRota model)
        {
            ...
            var getEntity = Mapper.Map<GetClientRota>(newRota);

            return CreatedAtRoute("GetClientRotaById", new { id = getEntity.RotaId }, getEntity);
        }
        ...
        public IActionResult Get()
        {
            ...
            var getEntities = _rotaRepository.Table.Where(r=>!r.Deleted).ProjectTo<GetClientRota>().ToList();
