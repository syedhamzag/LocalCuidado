$(function () {
    ...
    var js_basic_exampleTable = $('#involvingPartyTable').DataTable();

    $('#involvingPartyTable tbody').on('click', 'button.button-edit', function () {

        var td = $(this).parent();
        var itemName = js_basic_exampleTable.row(td).data()[0];
        var description = js_basic_exampleTable.row(td).data()[1];
        ...
        $('#btnCancel').show();
        // console.log(js_basic_exampleTable.row(td).data()[0])
    })
